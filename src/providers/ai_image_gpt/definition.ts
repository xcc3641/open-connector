...
import { aiImageGptActions } from "./actions.ts";
...
export const provider: ProviderDefinition = {
  ...
  description: "Generate GPT images through a self-hosted Sub2API gateway.",
  ...
  auth: [
    {
      ...
      placeholder: "sk-...",
      description:
        "A Sub2API API key bound to an OpenAI group with image generation enabled. The key is sent as a Bearer token.",
      extraFields: [
        {
          key: "baseUrl",
